...
ImuMpu6886::ImuMpu6886(uint8_t axis_order, uint32_t frequency, uint8_t spi_index, const BusSpi::stm32_spi_pins_t& pins) :
    ImuBase(axis_order, _bus),
    _bus(frequency, spi_index, pins)
{
}
ImuMpu6886::ImuMpu6886(uint8_t axis_order, uint32_t frequency, uint8_t spi_index, const BusSpi::spi_pins_t& pins) :
    ImuBase(axis_order, _bus),
    _bus(frequency, spi_index, pins)
{
}
#else
ImuMpu6886::ImuMpu6886(uint8_t axis_order, uint8_t i2c_index, const BusI2c::i2c_pins_t& pins, uint8_t i2c_address) :
    ImuBase(axis_order, _bus),
...
int32_t ImuMpu6886::read_temperature_raw() const
{
...
float ImuMpu6886::read_temperature() const
{
...
xyz_t ImuMpu6886::gyro_rps_from_raw(const mems_sensor_data_t::value_t& data) const
{
...
xyz_t ImuMpu6886::acc_from_raw(const mems_sensor_data_t::value_t& data) const
{
#if defined(LIBRARY_SENSORS_IMU_FIXED_AXES_XPOS_YPOS_ZPOS)
    return xyz_t {
...
acc_gyro_rps_t ImuMpu6886::acc_gyro_rps_from_raw(const acc_temperature_gyro_data_t::value_t& data) const
{
#if defined(LIBRARY_SENSORS_IMU_FIXED_AXES_XPOS_YPOS_ZPOS)
