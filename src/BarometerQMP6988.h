...
public:
    ...
    // SPI constructors
    BarometerQMP6988(uint32_t frequency, BUS_BASE::bus_index_e SPI_index, const BUS_SPI::stm32_spi_pins_t& pins);
    BarometerQMP6988(uint32_t frequency, BUS_BASE::bus_index_e SPI_index, const BUS_SPI::spi_pins_t& pins);
#else
    // I2C constructors
    BarometerQMP6988(BUS_BASE::bus_index_e I2C_index, const BUS_I2C::stm32_i2c_pins_t& pins, uint8_t I2C_address);
    BarometerQMP6988(const BUS_I2C::stm32_i2c_pins_t& pins, uint8_t I2C_address) : BarometerQMP6988(BUS_I2C::BUS_INDEX_0, pins, I2C_address) {}
    explicit BarometerQMP6988(const BUS_I2C::stm32_i2c_pins_t& pins) : BarometerQMP6988(pins, I2C_ADDRESS) {}

    BarometerQMP6988(BUS_BASE::bus_index_e I2C_index, const BUS_I2C::i2c_pins_t& pins, uint8_t I2C_address);
    BarometerQMP6988(const BUS_I2C::i2c_pins_t& pins, uint8_t I2C_address) : BarometerQMP6988(BUS_I2C::BUS_INDEX_0, pins, I2C_address) {}
    explicit BarometerQMP6988(const BUS_I2C::i2c_pins_t& pins) : BarometerQMP6988(pins, I2C_ADDRESS) {}
#endif
