...
public:
    ...
    // SPI constructor
    IMU_MPU6000(axis_order_e axisOrder, uint32_t frequency, BusBase::bus_index_e SPI_index, const BusSpi::stm32_spi_pins_t& pins);
    IMU_MPU6000(axis_order_e axisOrder, uint32_t frequency, BusBase::bus_index_e SPI_index, const BusSpi::spi_pins_t& pins);
#else
    // I2C constructors
    IMU_MPU6000(axis_order_e axisOrder, BusBase::bus_index_e I2C_index, const BusI2c::stm32_i2c_pins_t& pins, uint8_t I2C_address);
    IMU_MPU6000(axis_order_e axisOrder, const BusI2c::stm32_i2c_pins_t& pins, uint8_t I2C_address) : IMU_MPU6000(axisOrder, BusI2c::BUS_INDEX_0, pins, I2C_address) {}
    IMU_MPU6000(axis_order_e axisOrder, const BusI2c::stm32_i2c_pins_t& pins) : IMU_MPU6000(axisOrder, pins, I2C_ADDRESS) {}

    IMU_MPU6000(axis_order_e axisOrder, BusBase::bus_index_e I2C_index, const BusI2c::i2c_pins_t& pins, uint8_t I2C_address);
    IMU_MPU6000(axis_order_e axisOrder, const BusI2c::i2c_pins_t& pins, uint8_t I2C_address) : IMU_MPU6000(axisOrder, BusI2c::BUS_INDEX_0, pins, I2C_address) {}
    IMU_MPU6000(axis_order_e axisOrder, const BusI2c::i2c_pins_t& pins) : IMU_MPU6000(axisOrder, pins, I2C_ADDRESS) {}
#if !defined(FRAMEWORK_RPI_PICO) && !defined(FRAMEWORK_ESPIDF) &&!defined(FRAMEWORK_STM32_CUBE) && !defined(FRAMEWORK_TEST)
    IMU_MPU6000(axis_order_e axisOrder, TwoWire& wire, const BusI2c::i2c_pins_t& pins, uint8_t I2C_address);
#endif
#endif
...
#pragma pack(pop)
    ...
    static_assert(sizeof(spi_acc_gyro_data_t) == sizeof(acc_temperature_gyro_data_t) + BusBase::SPI_PRE_READ_BUFFER_SIZE);
public:
