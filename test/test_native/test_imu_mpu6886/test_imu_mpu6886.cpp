...
void test_mpu6886()
{
    ...
    static const IMU_MPU6886 imu(IMU_Base::XPOS_YPOS_ZPOS, spiFrequency, BusSpi::BUS_INDEX_0, BusSpi::spi_pins_t{});
#else
    static const IMU_MPU6886 imu(IMU_Base::XPOS_YPOS_ZPOS, BusI2c::i2c_pins_t{});
#endif
