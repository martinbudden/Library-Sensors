...
void test_icm20602()
{
    ...
    static const IMU_ICM20602 imu(IMU_Base::XPOS_YPOS_ZPOS, spiFrequency, BusSpi::BUS_INDEX_0, BusSpi::spi_pins_t{});
#else
    static const IMU_ICM20602 imu(IMU_Base::XPOS_YPOS_ZPOS, BusI2c::i2c_pins_t{});
#endif
